...
const PayWindow = ({svg}) => {
  return (
    <div className="pay-window">
      {svg === "apple" ? <ApplePayBig/> :
      <GooglePayBig/>}
      <p className="title16-regular-outfit">Enter your e-mail to get an invoice</p>
      <DefaultInput placeholder={"Enter your e-mail"} description={"Email"}/>
