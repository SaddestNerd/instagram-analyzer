...
import { BGCost, Discount, Emoji1, Emoji2, Emoji3, Emoji4, Emoji5, Emoji6, Emoji7, Emoji8, Emoji9, GooglePayBig } from "../../../shared/lib/icons/icons"
import { EmojiBlock, PayWindow, Timer } from "../../../widgets"
import { ApplePayButton, CVCInput, DefaultButton, DefaultInput, GooglePayButton, YearMonthInput } from "../../../shared"
  ...
  return (
    ...
    >
      ...
      <div className="upper-wrapper">
        ...
        <p className="upper-big-text">
          Time limited sale
        </p>
        <p className="upper-little-text">
      ...
      <div className="under-wrapper">
        <div className="under-wrapper-flex">
          ...
          <p className="title16-regular-outfit">
            Get full analysis to view more accurate & detailed analysis of your profile.
          </p>
          ...
          <div className="offer-wrapper">
            ...
            <div className="first-line">
              ...
              <div className="right title16-regular-outfit"><div className="purple">$9.99</div><div className="black">$1.00</div></div>
            </div>
          ...
          <div className="form-element">
            <div className="form-wrapper">
              <DefaultInput description={"First name"} placeholder={"Enter your first name"} />
              <DefaultInput description={"Last name"} placeholder={"Enter your last name"} />
              <DefaultInput description={"Email"} placeholder={"Enter your email"} />
            </div>
          </div>
          <div className="form-element">
            <p className="title18-semibold-outfit text-element">Credit card</p>
            <div className="form-wrapper">
              <DefaultInput description={"Card number"} placeholder={"XXXX XXXX XXXX XXXX"} />
        ...
        <div className="pay-wrapper">
          ...
          <div className="or-wrapper title11-regular-outfit">
            OR
          </div>
          <ApplePayButton />
          {/* <GooglePayButton/> */}
      ...
      <div className="footer-flex-wrapper">
        <div className="text-wrapper">
          <p className="title11-regular-outfit">*Your 3-Day Trial will last until (July 6, 2024). You can cancel anytime before then and will not be charged the full program amount.</p>
          <p className="title11-regular-outfit">No question asked, no small print. If you decide MetricMaster: Profile Analyzer is good for you, on (July 6, 2024) you will be charged one payment for $19.99 for your 7 days course ($2.86/day).</p>
          <p className="title11-regular-outfit">MetricMaster: Profile Analyzer will automatically charge your card $19.99 every 7 days so you don't lose access to your account. No refunds or credits except if you don't see results and follow our money-back policy. To cancel, simply let us know by email: support@followersreport.com</p>
        </div>
        <div className="flex-question">
          <div className="emoji-wrapper">
            <img className="emoji" src={Emoji9} alt="emoji" />
          </div>
          <p className="title14-regular-outfit">Have a questions?
            Reach our friendly support team <span className="title14-semibold-outfit">here</span></p>
        </div>
