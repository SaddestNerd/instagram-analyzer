        ...
        <div className="under-wrapper-flex">
          ...
          <div className="form-element">
            <div className="form-wrapper">
              <DefaultInput text={"First name"} placeholder={"Enter your first name"} />
              <DefaultInput text={"Last name"} placeholder={"Enter your last name"} />
          ...
          <div className="form-element">
            ...
            <div className="form-wrapper">
              <DefaultInput text={"Card number"} placeholder={"XXXX XXXX XXXX XXXX"} />
